...
export const PACKS = [
  {
    ...
    monthlyPrice: 350,
    annualPrice: 3500,
    features: ['Accès illimité', '1 boisson/session', 'WiFi premium'],
  },
  {
    id: 'p2',
    name: '2 Personnes',
    ...
    annualPrice: 6000,
    popular: true,
    features: ['Accès illimité', '2 boissons/session', 'WiFi premium', 'Réservations prioritaires'],
  },
  {
    id: 'p3',
    name: '3 Personnes',
    ...
    monthlyPrice: 800,
    annualPrice: 8000,
    features: ['Accès illimité', '3 boissons/session', 'WiFi premium', 'Réservations prioritaires', 'Salle podcast 1h/mois'],
  },
];
